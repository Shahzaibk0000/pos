...
public class SupplierDao {
    ...
    public void saveEmployee(Supplier supplier) {
        ...
        String query = "insert into supplier(supplier , contact_person , city , contact_number , license_detail , status , status_date) values('"+
    ...
    public void updateSupplier(Supplier supplier) {
        ...
        String query = "update supplier SET supplier = '" + supplierobj.getSupplier() +
                ...
                "' WHERE supplier_id = " + supplierobj.getId() + ";";
