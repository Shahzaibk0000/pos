...
public class InventoryDao {
    ...
    public ArrayList<Inventory> getAllInventory() {
        ...
        try (
            ...
            while (rs.next()) {
                ...
                inventoryObj.setCount(rs.getInt("count"));
    ...
    public void saveInventory(Inventory inventory) {
        ...
        String query = "insert into inventory (category_id , product_id ,purchase_price , quantity , total_price , storage_location , inventory_status , inventory_date , count) values(" +
                ...
                + inventoryobj.getDate()+ "'," + inventoryobj.getCount() +");";
    ...
    public void updateInventory(Inventory inventory) {
        Inventory inventoryObj = inventory;
        String query = "update inventory SET category_id = " + inventoryObj.getCategoryId() +
                ","+"product_id = " +inventoryObj.getProductId() +"," + "purchase_price = "+inventoryObj.getPurchasePrice()+","
                + "quantity = "+inventoryObj.getQuantity()+"," + "total_price = "+ inventoryObj.getTotalPrice() + "," +
                "storage_location = '" + inventoryObj.getStorageLocation() + "'," + "inventory_status = '"+ inventoryObj.getInventoryStatus() + "'," + "inventory_date = '" + inventoryObj.getDate() + "'," + "count = " + inventoryObj.getCount()
                + " WHERE inventory_id = " + inventoryObj.getInventoryId() + ";";
