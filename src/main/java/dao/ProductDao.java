...
public class ProductDao {
    ...
    public ArrayList<Product> getAllProduct() {
        ...
        try (
            ...
            while (rs.next()) {
                ...
                productObj.setSupplierId(rs.getInt("supplier_id"));
    ...
    public ArrayList<Product> searchProductById(int id) {
        ArrayList<Product> productList = new ArrayList<Product>();
        Product productObj = null;
        String query = "SELECT product.*, category.category_name , supplier.supplier FROM product INNER JOIN category ON product.category_id =category.category_id INNER JOIN supplier ON product.supplier_id = supplier.supplier_id WHERE product_id = " +id+ ";";
        try (
                Connection conn = DriverManager.getConnection(AppConstant.DB_URL, AppConstant.USER, AppConstant.PASS);
                Statement stmt = conn.createStatement();
                ResultSet rs = stmt.executeQuery(query);) {
